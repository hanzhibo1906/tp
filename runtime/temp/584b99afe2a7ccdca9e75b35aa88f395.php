<?php /*a:5:{s:62:"D:\phpStudy\WWW\tp1810\application\admin\view\books\lists.html";i:1554983929;s:57:"D:\phpStudy\WWW\tp1810\application\admin\view\layout.html";i:1550652520;s:64:"D:\phpStudy\WWW\tp1810\application\admin\view\public\header.html";i:1556502170;s:62:"D:\phpStudy\WWW\tp1810\application\admin\view\public\left.html";i:1554699641;s:64:"D:\phpStudy\WWW\tp1810\application\admin\view\public\footer.html";i:1551083535;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<table>
	<tr>
		<th colspan="7"><a href="<?php echo url('Books/add'); ?>"><button class="layui-btn">添加</button></a></th>
    </tr>
</table>
...
<table border="1" width="600">
  ...
  <?php if(is_array($booksInfo) || $booksInfo instanceof \think\Collection || $booksInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $booksInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
  <tr align="center">
    <td><?php echo htmlentities($v['b_id']); ?></td>
    <td><?php echo htmlentities($v['b_title']); ?></td>
    <td><?php echo htmlentities($v['b_name']); ?></td>
    <td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($v['open_time'])? strtotime($v['open_time']) : $v['open_time'])); ?></td>
    <td><?php echo htmlentities($v['b_content']); ?></td>
  </tr>
