<?php /*a:5:{s:69:"D:\phpStudy\WWW\tp1810\application\index\view\goods\goods_detail.html";i:1557110392;s:57:"D:\phpStudy\WWW\tp1810\application\index\view\layout.html";i:1556438806;s:64:"D:\phpStudy\WWW\tp1810\application\index\view\public\header.html";i:1556443865;s:61:"D:\phpStudy\WWW\tp1810\application\index\view\public\nav.html";i:1554776603;s:64:"D:\phpStudy\WWW\tp1810\application\index\view\public\footer.html";i:1556443861;}*/ ?>
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <?php if(app('session')->get('userInfo')['u_id'] == ''): ?>
        <span class="fr">
        	<span class="fl">你好，请
        ...
        <span class="fr">
        	<span class="fl">
            <a href="">欢迎 <font color="red"><?php echo htmlentities(app('session')->get('userInfo')['account']); ?></font> 登录</a>
        	</span>
        	<span class="ss">
            	<div class="ss_list">
    ...
    <div class="menu">
        ...
        <div class="nav">
            <div class="nav_t">全部商品分类</div>
                <div class="<?php echo htmlentities($is_show); ?>">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="zj" style="top:-<?php echo htmlentities($key*40); ?>px">
                                <div class="zj_l">
        ...
        <ul class="menu_r">
            ...
            <li><a href="<?php echo url('Goods/goodsList'); ?>?cate_id=<?php echo htmlentities($v['cate_id']); ?>"><?php echo htmlentities($v['cate_name']); ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="./uploads/<?php echo htmlentities($goodsInfo['goods_img']); ?>" title="Images" class="MagicZoom" id="MagicZoom"><img src="./uploads/<?php echo htmlentities($goodsInfo['goods_img']); ?>" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img src="./static/index/images/ps1.jpg" tsImgS="images/ps1.jpg" width="79" height="79" /></li>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            <div class="des_name">
                <p><?php echo htmlentities($goodsInfo['goods_name']); ?></p>
                “开业巨惠，北京专柜直供”，不光低价，“真”才靠谱！
                <input type="hidden" id="goods_id" value="<?php echo htmlentities($goodsInfo['goods_id']); ?>">
            </div>
            <div class="des_price">
                本店价格：<b>￥<?php echo htmlentities($goodsInfo['shop_price']); ?></b><br />
                库存：<b><?php echo htmlentities($goodsInfo['goods_number']); ?></b><br />
            </div>
            ...
            <div class="des_join">
                <div class="j_nums">
                    <input type="hidden" id="goods_number" value="<?php echo htmlentities($goodsInfo['goods_number']); ?>">
                    <input type="text" value="1" id="buy_number" class="n_ipt" />
                    <input type="button" class="n_btn_1" id="add" />
                    <input type="button" class="n_btn_2" id="less" />   
                </div>
                <span class="fl">
                    <a id="addCart"><img src="./static/index/images/j_car.png" /></a>
                    </span>
            </div>            
        </div>    
       ...
       $(function(){
        layui.use(['layer'],function(){
            ...
            $('#addCart').click(function(){
                ...
                //把商品id 购买数量传给控制器
                $.post(
                    "<?php echo url('Cart/addCart'); ?>",
                    {goods_id:goods_id,buy_number:buy_number},
                    function(res){
                        if(res.code==1){
                            layer.open({
                                content: '添加成功,是否前去购物车?'
                                ,btn: ['是', '否']
